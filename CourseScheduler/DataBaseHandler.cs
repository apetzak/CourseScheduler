...
using CourseScheduler.CourseSchedulerDBDataSetTableAdapters;
using CourseScheduler.Properties;
...
namespace CourseScheduler
{
    public class DataBaseHandler
    {
        ...
        {/*
            ...
            CourseJoinTableAdapter courseJoinTableAdapter = new CourseJoinTableAdapter();
